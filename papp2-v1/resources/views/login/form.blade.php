<form class="w-full max-w-sm mx-auto">
  <div class="mb-6 flex items-center">
    ...
    <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-grey-500" 
      id="name" type="text" placeholder="Entrer un nom d'utilisateur">
  </div>
  <div class="mb-6 flex items-center">
    ...
    <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-grey-500" 
      id="email" type="email" placeholder="Entrer un email valide">
  </div>
  <div class="mb-6 flex items-center">
    ...
    <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-grey-500" 
      id="password" type="password" placeholder="Entrer un mot de passe de min. 4 caractères">
  </div>
